    ...
    <>
      ...
      <body class="bg-theme-black">
        ...
        <div class="flex justify-center my-40">
          <a href="/" class="bg-theme-pink rounded-xl font-bold text-3xl text-theme-dark-pink hover:text-theme-medium-grey p-6 hover:-translate-y-2 hover:scale-105 transition ease-in-out duration-300 animate-fadeInSec">Home</a>
        </div>
        <Footer/>
      </body>
    </>
